"""
Django settings for ofis project.
...
SECRET_KEY = 'django-insecure-wm-j31rvov+j@t2mk4-j+_48(&q_&unuwy2)*jqi%f9c@cyx0q'
...
WSGI_APPLICATION = 'ofis.wsgi.application'
...
# Yüklenen medya dosyalarının kaydedileceği kök dizin
